<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="IngresoProducto.aspx.cs" Inherits="Inventario.IngresoProducto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
        ...
        <tr>
            ...
            <asp:RegularExpressionValidator ControlToValidate="TextUnidades" ID="RegularExpressionValidator1" runat="server" ErrorMessage="Ingrese Numero Entero" ValidationExpression="^\d+"></asp:RegularExpressionValidator>
            </td>
