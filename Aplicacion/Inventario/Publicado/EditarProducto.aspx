<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditarProducto.aspx.cs" Inherits="Inventario.EditarProducto" %>
...
<asp:Panel ID="pnIngreso" runat="server" Visible="false" DefaultButton="btnActualizar">
    ...
    <tr>
        ...
        <td style="border:none;">
            <asp:DropDownList ID="ddlClasificacion" runat="server" Height="22px" Width="128px"></asp:DropDownList>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td style="border:none;">
            <asp:DropDownList ID="ddlControlado" runat="server" Height="22px" Width="128px"></asp:DropDownList>
        </td>
        <td style="border:none;">
