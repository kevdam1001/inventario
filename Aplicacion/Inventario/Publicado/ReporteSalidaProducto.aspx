<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteSalidaProducto.aspx.cs" Inherits="Inventario.ReporteSalidaProducto" %>
...
<asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="Server" />
    ...
    <center>
        ...
        <tr>
        <td style="border:none;">Fecha Inicial</td>
        ...
        <td></td>
        <td style="border:none;">Fecha Final </td>
        <td style="border:none;"><asp:TextBox Font-Size="Small" width="171px" 
