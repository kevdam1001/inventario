...
{
    public partial class rpBajasProducto : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
	        {
                if (!Page.IsPostBack)
                {
                    ...
                    GenerarReporte();
                    vProducto.ToolPanelView = CrystalDecisions.Web.ToolPanelViewType.None;
                }
            }
        }
        ...
        private void GenerarReporte()
        {
            ...
            vProducto.ReportSource = Server.MapPath("rp_BajasProducto.rpt");
