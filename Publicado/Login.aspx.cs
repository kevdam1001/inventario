...
namespace Inventario
{
    public partial class Login : System.Web.UI.Page
    {
        ...
        protected void ButtonAceptar_Click(object sender, EventArgs e)
        {
            ...
            bool[] Existe = new bool[10];
            string menu = null;
            bool[] Accesos = new bool[100];
            ...
            if (Resultado.Rows.Count > 0)
            {
                if (Resultado.Rows[0].ItemArray[0].ToString() == TextPass.Text)
                {
                    ...
                    foreach (DataRow r in Resultado.Rows)
                    {
                        ...
                        if (r[1].ToString().Contains("Reportes")) //El contains es lo que aparece en la columna "Menu" de la tabla "Pagina"
                        {
                            if (!Existe[7])
                            {
                                Opciones[7] = "<li ><a href='Reportes.aspx'>Reportes</a><ul>";
                                Existe[7] = true;
                            }
                        }
                        ...
                        else if (r[1].ToString().Contains("Equipo"))
                        {
                            if (!Existe[2])
                            {
                                Opciones[2] = "<li ><a href='#'>Equipo</a><ul>";
                                Existe[2] = true;
                            }
                            Opciones[2] += r[1].ToString();
                        }
                        else if (r[1].ToString().Contains("Egreso")||r[1].ToString().Contains("Ajuste") )
                        {
                            if (!Existe[3])
                            {
                                Opciones[3] = "<li ><a href='#'>Ingreso/Egreso</a><ul>";
                                Existe[3] = true;
                            }
                            Opciones[3] += r[1].ToString();
                        }
                        else if (r[1].ToString().Contains("Ingreso"))
                        {
                            if (!Existe[3])
                            {
                                Opciones[3] = "<li ><a href='#'>Ingres/Egres Producto</a><ul>";
                                Existe[3] = true;
                            }
                            Opciones[3] += r[1].ToString();
                        }
                        else if (r[1].ToString().Contains("Producto") || r[1].ToString().Contains("BuscarReactivo"))
                        {
                            if (!Existe[4])
                            {
                                Opciones[4] = "<li ><a href='#'>Producto</a><ul>";
                                Existe[4] = true;
                            }
                        ...
                        else if (r[1].ToString().Contains("Herramienta"))
                        {
                            if (!Existe[5])
                            {
                                Opciones[5] = "<li ><a href='#'>Herramienta</a><ul>";
                                Existe[5] = true;
                            }
                        ...
                        else if (r[1].ToString().Contains("Cristaleria"))
                        {
                            if (!Existe[6])
                            {
                                Opciones[6] = "<li ><a href='#'>Cristaleria</a><ul>";
                                Existe[6] = true;
                            }
                            Opciones[6] += r[1].ToString();
                        }
                        else
                        {
                            if (!Existe[8])
                            {
                                Opciones[8] = "<li ><a href='#'>Catálogos</a><ul>";
                                Existe[8] = true;
                            }
                            Opciones[8] += r[1].ToString();
                        }
        ...
        protected void lkbtnPasswordChange_Click(object sender, EventArgs e)
        {
            // Response.RedirectPermanent("PasswordChange.aspx");
            // Response.Write("<script language=javascript>alert('Operación realizada exitosamente.');</script>");
            Response.RedirectPermanent("RecuperarPw.aspx");
        }
    }
}
