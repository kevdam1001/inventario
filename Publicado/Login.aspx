<%@ Page Language="C#" UnobtrusiveValidationMode="None" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Inventario.Login" %>
...
<div id="main" class="box">
    ...
    <center>
                <%--<asp:LinkButton ID="lkbtnPasswordChange" runat="server" Text="Olvidé mi contraseña." OnClick="lkbtnPasswordChange_Click" CausesValidation="False"></asp:LinkButton>--%>
        <br />
