<%@ Page Title="" Language="C#" UnobtrusiveValidationMode="None" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditarEquipo.aspx.cs" Inherits="Inventario.EditarEquipo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="article">
    <h2><span>Editar Equipo</span></h2> 
    </div>
    <center>
    ...
    <table style="border:none;" >
        ...
        <tr>
            ...
            <td style="border:none;">
                <asp:TextBox Font-Size="Small" width="128px" 
                    ID="TextCodigo" runat="server" MaxLength="50" Enabled="False"></asp:TextBox >
        ...
        <tr>
            ...
            <td style="border:none;">
                <asp:TextBox Font-Size="Small" width="128px" 
                    ID="TextSerie" runat="server" MaxLength="50" Enabled="False"></asp:TextBox >
        ...
        <tr>    
         ...
         <tr>
            <td   style="border:none;"><asp:Label ID="LabelAc" runat="server" Text="Activo:"></asp:Label><br /><br /></td>
            <td   style="border:none;"><asp:CheckBox ID="CheckActivo" runat="server" /></td>
