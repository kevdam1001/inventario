<%@ Page Title="" Language="C#" UnobtrusiveValidationMode="None" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditarEgresoProducto.aspx.cs" Inherits="Inventario.EditarEgresoProducto" %>
    ...
    <asp:Panel ID="pnBusqueda" runat="server" Visible="true" DefaultButton="btnBuscar">
        ...
        <asp:panel id="pnListadoEncontrado" runat="server" ScrollBars="Auto">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Cantidad" HeaderText="Medida Egresada" />
        ...
        <ContentTemplate>
            <table style="border:none;">
                <tr>
                    ...
                    <td style="border:none;"><asp:DropDownList ID="ddlSede" Font-Size="Small" runat="server" Width="175px" AutoPostBack="true" OnSelectedIndexChanged="ddlSede_SelectedIndexChanged">
                    ...
                    <td style="border:none;"><asp:DropDownList ID="ddlFacultad" Font-Size="Small" runat="server" Width="175px" AutoPostBack="true" OnSelectedIndexChanged="ddlFacultad_SelectedIndexChanged">
                        <asp:ListItem>--Seleccionar--</asp:ListItem>
                    </asp:DropDownList>
                ...
                <tr>
                    ...
                    <td style="border:none;"><asp:DropDownList ID="ddlCarrera" Font-Size="Small" runat="server" Width="175px" AutoPostBack="true" OnSelectedIndexChanged="ddlCarrera_SelectedIndexChanged">
                        <asp:ListItem>--Seleccionar--</asp:ListItem>
                    </asp:DropDownList>
                    ...
                    <td style="border:none;"><asp:DropDownList ID="ddlCurso" Font-Size="Small" runat="server" Width="175px" AutoPostBack="true" OnSelectedIndexChanged="ddlCurso_SelectedIndexChanged">
                        <asp:ListItem>--Seleccionar--</asp:ListItem>
                    </asp:DropDownList>
                ...
                <tr>
                    ...
                    <td style="border:none;" colspan="3"><asp:DropDownList ID="ddlPractica" 
                            Font-Size="Small" runat="server" Width="460px" OnSelectedIndexChanged="ddlPractica_SelectedIndexChanged">
                        <asp:ListItem>--Seleccionar--</asp:ListItem>
                    </asp:DropDownList>
                ...
                <tr>
                    ...
                    <td style="border:none;"><asp:DropDownList ID="ddlCiclo" Font-Size="Small" 
                            runat="server" Width="175px" OnSelectedIndexChanged="ddlCiclo_SelectedIndexChanged">
                        <asp:ListItem>--Seleccionar--</asp:ListItem>
                    </asp:DropDownList>
                ...
                <tr>
                    ...
                    <td style="border:none;" colspan="3"><asp:TextBox ID="txtObservaciones" runat="server" Height="47px" MaxLength="150" Width="460px" TextMode="MultiLine"></asp:TextBox></td>
                </tr>
            </table>
        </ContentTemplate>
        <Triggers>
