    ...
    public partial class EgresoProducto : System.Web.UI.Page
    {
        ...
        protected void ButtonBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (Resultado.Rows.Count > 0)
            {
                ...
                {
                    Data.Rows[i].Cells[3].Text = Data.Rows[i].Cells[3].Text.Split(' ')[0];
                }
            }
            else
            {
        ...
        protected void Data_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            Actual.Rows.Add(Data.Rows[i].Cells[1].Text, Server.HtmlDecode(Data.Rows[i].Cells[2].Text), Data.Rows[i].Cells[3].Text, Data.Rows[i].Cells[4].Text, Data.Rows[i].Cells[5].Text, (Convert.ToDouble(Data.Rows[i].Cells[4].Text.Split(' ')[0]) * Convert.ToDouble(Data.Rows[i].Cells[5].Text)).ToString() + " " + Data.Rows[i].Cells[4].Text.Split(' ')[1]);
