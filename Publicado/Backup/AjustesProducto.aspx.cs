...
namespace Inventario
{
    public partial class AjustesProducto : System.Web.UI.Page
    {
        ...
        protected void ButtonBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (Tipo.SelectedIndex == 0)
            {
                ...
                if (Resultado.Rows.Count > 0)
                {
                    ...
                    {
                        DataBaja.Rows[i].Cells[3].Text = DataBaja.Rows[i].Cells[3].Text.Split(' ')[0];
                    }
                }
                else
                {
        ...
        protected void Data_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            Actual.Rows.Add(DataBaja.Rows[i].Cells[1].Text, Server.HtmlDecode(DataBaja.Rows[i].Cells[2].Text), Server.HtmlDecode(DataBaja.Rows[i].Cells[3].Text), DataBaja.Rows[i].Cells[4].Text, DataBaja.Rows[i].Cells[5].Text, (Convert.ToDouble(DataBaja.Rows[i].Cells[4].Text.Split(' ')[0]) * Convert.ToDouble(DataBaja.Rows[i].Cells[5].Text)).ToString() + " " + DataBaja.Rows[i].Cells[4].Text.Split(' ')[1]);
        ...
        protected void DataDevolucion_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Agregar")
            {
                ...
                Opcion.Text = "SUMAR PRODUCTO A PRACTICA"; 
            ...
            {
                Opcion.Text = "DEVOLVER PRODUCTO DE PRACTICA"; 
