<%@ Page Language="C#" UnobtrusiveValidationMode="None" AutoEventWireup="true" CodeBehind="rpCostoPracticas.aspx.cs" Inherits="Inventario.rpCostoPracticas" %>
...
<body>
    ...
    <br />
        <br />
        <CR:CrystalReportViewer ID="vProducto" runat="server" AutoDataBind="true" HasPrintButton="True" />
    <br />
