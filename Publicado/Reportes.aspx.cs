...
namespace Inventario
{
    public partial class Reportes : System.Web.UI.Page
    {
        ...
        protected void LinkButton10_Click(object sender, EventArgs e)
        {
            ...
            str = str.Split(' ')[0];
            string encode = Convert.ToBase64String(System.Text.ASCIIEncoding.ASCII.GetBytes(str));
            Response.Redirect("rpReactivosSinMovimientos.aspx?str=" + encode);
        }
        ...
        protected void LinkButton11_Click(object sender, EventArgs e)
        {
            ...
            str = str.Split(' ')[0];
            string encode = Convert.ToBase64String(System.Text.ASCIIEncoding.ASCII.GetBytes(str));
            Response.Redirect("rpReactivosUltimaFechaUso.aspx?str=" + encode);
        }

        protected void LinkButton12_Click(object sender, EventArgs e)
        {
            Response.Redirect("rpReportemensualrcontrolados.aspx");
        }
    }
}
