<%@ Page Title="" Language="C#" UnobtrusiveValidationMode="None" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditarIngresoProducto.aspx.cs" Inherits="Inventario.EditarIngresoProducto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <center>
        <asp:Panel ID="pnBusqueda" runat="server" Visible="true" DefaultButton="btnBusqueda">
            ...
            <asp:Panel ID="pnDatosEncontrados" runat="server" ScrollBars="Auto" 
                Width="577px">
                <asp:GridView ID="gvDatosEncontrados" runat="server" 
                    ...
                    <Columns>
                        <asp:BoundField DataField="IdEntrada" HeaderText="ID" />
            ...
            <asp:Label ID="lblId" runat="server" ForeColor="Blue" Visible="false"></asp:Label>
            ...
            <asp:Panel ID="pnEditarIngreso" runat="server" Visible="false" DefaultButton="btnActualizarIngreso">
                ...
                <tr>
                    ...
                    <td style="border:none;">
                        ...
                        <br />
                        <asp:RegularExpressionValidator ControlToValidate="txtUnidades" ID="RegularExpressionValidator1" runat="server" ErrorMessage="Ingrese número entero" ValidationExpression="^[0-9]*(\.[0-9]{0,3})?$"></asp:RegularExpressionValidator>
                    </td>
                </tr>
                <tr>
                    <td style="border:none;">
