...
namespace Inventario
{
    public partial class EditarProducto : System.Web.UI.Page
    {
        ...
        protected void btnBuscarExistencias_Click(object sender, EventArgs e)
        {
            Response.Redirect("BuscarReactivo.aspx");
        }

        protected void BuscarReactivoFV_Click(object sender, EventArgs e)
        {
            Response.Redirect("BuscarReactivoFV.aspx");
        }
    }
}
